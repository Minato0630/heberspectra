  ...
  try {
    ...
    if (conn) {
      ...
      return {
        ...
        settings: {
          eventDate: (doc.settings && doc.settings.eventDate) || "2026-10-12T09:00:00",
          registrationDeadline: (doc.settings && doc.settings.registrationDeadline) || "2026-10-11T23:59:59"
        }
      };
    }
  } catch (err) {
      ...
      await SpectraModel.findOneAndUpdate(
        { key: 'main' },
        {
          $set: {
            ...
            settings: data.settings || { eventDate: "2026-10-12T09:00:00", registrationDeadline: "2026-10-11T23:59:59" },
            updatedAt: new Date()
          }
        },
